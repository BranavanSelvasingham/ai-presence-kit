...
assert.match(releaseReadiness, /installed-package Node evidence, not a browser or visual proof/);
...
const vanillaStatusSurfaceSmokeEnd = releaseConsumerSmoke.indexOf('join(tempDir, "composer-lane-smoke.mjs")');
...
assert.match(goalLoop, /Published-package consumer smoke now covers generic chat, OpenAI Responses, assistant lifecycle, assistant-ui ExternalStoreRuntime, vanilla status-surface, and composer-lane adoption paths/);
...
assert.match(rootReadme, /release consumer smoke now repeats the OpenAI Responses adapter path, assistant lifecycle adapter path, assistant-ui ExternalStoreRuntime route, vanilla status-surface pattern, and composer-lane pattern/i);
