...
for (const requiredFile of [
  ...
  "examples/vercel-ai-sdk-presence.mjs",
  "tests/vercel-ai-sdk-presence.test.mjs",
...
assert.match(rootManifest.scripts.check, /examples\/vercel-ai-sdk-presence\.mjs/);
...
assert.equal(rootManifest.scripts["demo:vercel-ai-sdk"], "node examples/vercel-ai-sdk-presence.mjs");
...
assert.match(rootManifest.scripts.validate, /npm run demo:vercel-ai-sdk/);
...
assert.match(rootManifest.scripts.test, /tests\/vercel-ai-sdk-presence\.test\.mjs/);
...
assert.match(releaseRunbook, /Vercel AI SDK `useChat` status\/message path/);
...
assert.match(releaseRunbook, /vanilla status-surface adoption path/);
...
assert.match(releaseRunbook, /documented `useChat` `status: "submitted"`/);
assert.match(releaseRunbook, /`status: "streaming"` with empty assistant output/);
assert.match(releaseRunbook, /`status: "streaming"` with assistant text/);
assert.match(releaseRunbook, /`status: "ready"`/);
assert.match(releaseRunbook, /`status: "error"`/);
assert.match(releaseRunbook, /onFinish\.isAbort/);
assert.match(releaseRunbook, /vercel-ai-sdk consumer smoke ok/);
assert.match(releaseRunbook, /framework=vercel-ai-sdk/);
assert.match(releaseRunbook, /statusPath/);
assert.match(releaseRunbook, /frameworkEventPath/);
assert.match(releaseRunbook, /status=streaming/);
assert.match(releaseRunbook, /state=waiting/);
assert.match(releaseRunbook, /phase=before-output/);
assert.match(releaseRunbook, /surfaceFirstOutputMs=none/);
assert.match(releaseRunbook, /abortState=interrupted/);
assert.match(releaseRunbook, /errorState=error/);
assert.match(releaseRunbook, /not a browser, visual, live Vercel, or Vercel package integration/);
...
assert.match(releaseRunbook, /generic chat `input`, `pause`, `submit`, `stream-open`, `token`, and `done` events/);
assert.match(releaseRunbook, /vanilla status-surface consumer smoke ok/);
assert.match(releaseRunbook, /renderer=status-surface/);
assert.match(releaseRunbook, /surfacePhase=before-output/);
assert.match(releaseRunbook, /surfaceAttention=response/);
assert.match(releaseRunbook, /surfaceEvent=stream-open/);
assert.match(releaseRunbook, /assistantTextEmpty=true/);
assert.match(releaseRunbook, /surfaceFirstOutputMs=none/);
assert.match(releaseRunbook, /surfaceLeadMs/);
assert.match(releaseRunbook, /installed-package Node smoke evidence, not browser or visual evidence/);
assert.match(releaseRunbook, /Vercel AI SDK adapter path for `submitted`, `streaming`, and `ready` updates/);
...
assert.match(releaseReadiness, /npm run demo:vercel-ai-sdk/);
...
assert.match(releaseReadiness, /named Vercel AI SDK proof/);
...
assert.match(releaseReadiness, /framework=vercel-ai-sdk/);
...
assert.match(releaseReadiness, /Vercel AI SDK `useChat` status\/message path/);
...
assert.match(releaseReadiness, /vercel-ai-sdk consumer smoke ok/);
assert.match(releaseReadiness, /framework=vercel-ai-sdk/);
assert.match(releaseReadiness, /statusPath/);
assert.match(releaseReadiness, /frameworkEventPath/);
assert.match(releaseReadiness, /status=streaming/);
assert.match(releaseReadiness, /state=waiting/);
assert.match(releaseReadiness, /phase=before-output/);
assert.match(releaseReadiness, /surfaceFirstOutputMs=none/);
assert.match(releaseReadiness, /abortState=interrupted/);
assert.match(releaseReadiness, /errorState=error/);
assert.match(releaseReadiness, /not browser, visual, live Vercel, or Vercel package proofs/);
...
assert.match(releaseReadiness, /vanilla status-surface adoption path/);
assert.match(releaseReadiness, /vanilla status-surface consumer smoke ok/);
assert.match(releaseReadiness, /renderer=status-surface/);
assert.match(releaseReadiness, /surfacePhase=before-output/);
assert.match(releaseReadiness, /surfaceAttention=response/);
assert.match(releaseReadiness, /surfaceEvent=stream-open/);
assert.match(releaseReadiness, /assistantTextEmpty=true/);
assert.match(releaseReadiness, /surfaceFirstOutputMs=none/);
assert.match(releaseReadiness, /positive `surfaceLeadMs`/);
...
assert.match(releaseReadiness, /installed-package Node evidence, not browser, visual, live Vercel, or Vercel package proofs/);
...
assert.match(releaseConsumerSmoke, /vercel-ai-sdk-smoke\.mjs/);
...
assert.match(releaseConsumerSmoke, /status: "error"/);
assert.match(releaseConsumerSmoke, /parts: \[\{ type: "text", text: "" \}\]/);
assert.match(releaseConsumerSmoke, /isAbort: true/);
assert.match(releaseConsumerSmoke, /vercel-ai-sdk consumer smoke ok/);
assert.match(releaseConsumerSmoke, /framework=vercel-ai-sdk/);
assert.match(releaseConsumerSmoke, /statusPath=/);
assert.match(releaseConsumerSmoke, /frameworkEventPath=/);
assert.match(releaseConsumerSmoke, /status=/);
assert.match(releaseConsumerSmoke, /state=/);
assert.match(releaseConsumerSmoke, /phase=/);
assert.match(releaseConsumerSmoke, /assistantTextEmpty=/);
assert.match(releaseConsumerSmoke, /surfaceFirstOutputMs=/);
assert.match(releaseConsumerSmoke, /abortState=/);
assert.match(releaseConsumerSmoke, /errorState=/);
assert.match(releaseConsumerSmoke, /vanilla-status-surface-smoke\.mjs/);
assert.match(releaseConsumerSmoke, /vanilla status-surface consumer smoke ok/);
assert.match(releaseConsumerSmoke, /renderer=status-surface/);
assert.match(releaseConsumerSmoke, /data-renderer/);
assert.match(releaseConsumerSmoke, /data-presence-state/);
assert.match(releaseConsumerSmoke, /data-presence-phase/);
assert.match(releaseConsumerSmoke, /data-presence-attention/);
assert.match(releaseConsumerSmoke, /data-presence-event/);
assert.match(releaseConsumerSmoke, /data-assistant-text-empty/);
assert.match(releaseConsumerSmoke, /data-stream-open-ms/);
assert.match(releaseConsumerSmoke, /data-first-output-ms/);
assert.match(releaseConsumerSmoke, /data-lead-ms/);
assert.match(releaseConsumerSmoke, /surfaceFirstOutputMs=/);
assert.match(releaseConsumerSmoke, /surfaceLeadMs=/);
assert.match(releaseConsumerSmoke, /presenceBeforeOutputMs=/);
...
const responsesSmokeEnd = releaseConsumerSmoke.indexOf('join(tempDir, "vanilla-status-surface-smoke.mjs")');
...
const vanillaStatusSurfaceSmokeStart = releaseConsumerSmoke.indexOf(
  'join(tempDir, "vanilla-status-surface-smoke.mjs")',
);
const vanillaStatusSurfaceSmokeEnd = releaseConsumerSmoke.indexOf('join(tempDir, "vercel-ai-sdk-smoke.mjs")');
assert.ok(vanillaStatusSurfaceSmokeStart > -1, "vanilla status-surface smoke source missing");
assert.ok(
  vanillaStatusSurfaceSmokeEnd > vanillaStatusSurfaceSmokeStart,
  "vanilla status-surface smoke source boundary missing",
);
const vanillaStatusSurfaceConsumerSmoke = releaseConsumerSmoke.slice(
  vanillaStatusSurfaceSmokeStart,
  vanillaStatusSurfaceSmokeEnd,
);
assert.match(vanillaStatusSurfaceConsumerSmoke, /from "@ai-presence\/core"/);
assert.match(vanillaStatusSurfaceConsumerSmoke, /from "@ai-presence\/adapters"/);
assert.match(vanillaStatusSurfaceConsumerSmoke, /createChatEventAdapter/);
assert.match(vanillaStatusSurfaceConsumerSmoke, /statusSurfaceForPresence/);
assert.match(vanillaStatusSurfaceConsumerSmoke, /data-renderer/);
assert.match(vanillaStatusSurfaceConsumerSmoke, /data-presence-state/);
assert.match(vanillaStatusSurfaceConsumerSmoke, /data-presence-phase/);
assert.match(vanillaStatusSurfaceConsumerSmoke, /data-presence-attention/);
assert.match(vanillaStatusSurfaceConsumerSmoke, /data-presence-event/);
assert.match(vanillaStatusSurfaceConsumerSmoke, /data-assistant-text-empty/);
assert.match(vanillaStatusSurfaceConsumerSmoke, /data-stream-open-ms/);
assert.match(vanillaStatusSurfaceConsumerSmoke, /data-first-output-ms/);
assert.match(vanillaStatusSurfaceConsumerSmoke, /data-lead-ms/);
assert.match(vanillaStatusSurfaceConsumerSmoke, /vanilla status-surface consumer smoke ok/);
assert.match(vanillaStatusSurfaceConsumerSmoke, /surfaceFirstOutputMs=/);
assert.match(vanillaStatusSurfaceConsumerSmoke, /surfaceLeadMs=/);
assert.match(vanillaStatusSurfaceConsumerSmoke, /summary\.presenceBeforeOutputMs/);
assert.doesNotMatch(vanillaStatusSurfaceConsumerSmoke, /from ["']@assistant-ui\/|require\(["']@assistant-ui\//);
assert.doesNotMatch(vanillaStatusSurfaceConsumerSmoke, /from ["']openai["']|require\(["']openai["']\)/);
assert.doesNotMatch(vanillaStatusSurfaceConsumerSmoke, /from ["'](?:jsdom|happy-dom)["']|require\(["'](?:jsdom|happy-dom)["']\)/);
assert.doesNotMatch(vanillaStatusSurfaceConsumerSmoke, /document\.|window\.|HTMLElement|customElements/);
assert.doesNotMatch(vanillaStatusSurfaceConsumerSmoke, /@ai-presence\/face|@ai-presence\/react|react-dom|ReactDOM|renderPresenceFaceSvg|<svg|svg/i);

const vercelAISDKSmokeStart = releaseConsumerSmoke.indexOf('join(tempDir, "vercel-ai-sdk-smoke.mjs")');
const vercelAISDKSmokeEnd = releaseConsumerSmoke.indexOf('join(tempDir, "composer-lane-smoke.mjs")');
assert.ok(vercelAISDKSmokeStart > -1, "Vercel AI SDK smoke source missing");
assert.ok(vercelAISDKSmokeEnd > vercelAISDKSmokeStart, "Vercel AI SDK smoke source boundary missing");
const vercelAISDKConsumerSmoke = releaseConsumerSmoke.slice(
  vercelAISDKSmokeStart,
  vercelAISDKSmokeEnd,
);
assert.match(vercelAISDKConsumerSmoke, /from "@ai-presence\/core"/);
assert.match(vercelAISDKConsumerSmoke, /from "@ai-presence\/adapters"/);
assert.match(vercelAISDKConsumerSmoke, /createPresenceRuntime/);
assert.match(vercelAISDKConsumerSmoke, /createPresenceTrace/);
assert.match(vercelAISDKConsumerSmoke, /presenceControlInputsForSnapshot/);
assert.match(vercelAISDKConsumerSmoke, /summarizePresenceTrace/);
assert.match(vercelAISDKConsumerSmoke, /createVercelAISDKAdapter/);
assert.match(vercelAISDKConsumerSmoke, /status: "submitted"/);
assert.match(vercelAISDKConsumerSmoke, /status: "streaming"/);
assert.match(vercelAISDKConsumerSmoke, /status: "ready"/);
assert.match(vercelAISDKConsumerSmoke, /status: "error"/);
assert.match(vercelAISDKConsumerSmoke, /role: "assistant"/);
assert.match(vercelAISDKConsumerSmoke, /parts: \[\{ type: "text", text: "" \}\]/);
assert.match(vercelAISDKConsumerSmoke, /isAbort: true/);
assert.match(vercelAISDKConsumerSmoke, /data-framework/);
assert.match(vercelAISDKConsumerSmoke, /data-status/);
assert.match(vercelAISDKConsumerSmoke, /data-presence-state/);
assert.match(vercelAISDKConsumerSmoke, /data-presence-phase/);
assert.match(vercelAISDKConsumerSmoke, /data-assistant-text-empty/);
assert.match(vercelAISDKConsumerSmoke, /data-presence-before-output/);
assert.match(vercelAISDKConsumerSmoke, /vercel-ai-sdk consumer smoke ok/);
assert.match(vercelAISDKConsumerSmoke, /framework=vercel-ai-sdk/);
assert.match(vercelAISDKConsumerSmoke, /statePath=/);
assert.match(vercelAISDKConsumerSmoke, /eventPath=/);
assert.match(vercelAISDKConsumerSmoke, /statusPath=/);
assert.match(vercelAISDKConsumerSmoke, /frameworkEventPath=/);
assert.match(vercelAISDKConsumerSmoke, /status=/);
assert.match(vercelAISDKConsumerSmoke, /state=/);
assert.match(vercelAISDKConsumerSmoke, /phase=/);
assert.match(vercelAISDKConsumerSmoke, /assistantTextEmpty=/);
assert.match(vercelAISDKConsumerSmoke, /surfaceFirstOutputMs=/);
assert.match(vercelAISDKConsumerSmoke, /streamOpenMs=/);
assert.match(vercelAISDKConsumerSmoke, /firstOutputMs=/);
assert.match(vercelAISDKConsumerSmoke, /leadMs=/);
assert.match(vercelAISDKConsumerSmoke, /presenceBeforeOutputMs=/);
assert.match(vercelAISDKConsumerSmoke, /finalState=/);
assert.match(vercelAISDKConsumerSmoke, /hasOutput=/);
assert.match(vercelAISDKConsumerSmoke, /complete=/);
assert.match(vercelAISDKConsumerSmoke, /interrupted=/);
assert.match(vercelAISDKConsumerSmoke, /abortState=/);
assert.match(vercelAISDKConsumerSmoke, /errorState=/);
assert.match(vercelAISDKConsumerSmoke, /summary\.presenceBeforeOutputMs/);
assert.match(vercelAISDKConsumerSmoke, /PresenceEvent\.TOKEN/);
assert.match(vercelAISDKConsumerSmoke, /PresenceState\.READY/);
assert.match(vercelAISDKConsumerSmoke, /PresenceState\.INTERRUPTED/);
assert.match(vercelAISDKConsumerSmoke, /PresenceState\.ERROR/);
assert.doesNotMatch(vercelAISDKConsumerSmoke, /from ["']node:/);
assert.doesNotMatch(vercelAISDKConsumerSmoke, /from ["']ai["']|require\(["']ai["']\)/);
assert.doesNotMatch(vercelAISDKConsumerSmoke, /from ["']@ai-sdk\/|require\(["']@ai-sdk\//);
assert.doesNotMatch(vercelAISDKConsumerSmoke, /from ["']@assistant-ui\/|require\(["']@assistant-ui\//);
assert.doesNotMatch(vercelAISDKConsumerSmoke, /from ["']openai["']|require\(["']openai["']\)/);
assert.doesNotMatch(vercelAISDKConsumerSmoke, /from ["'](?:jsdom|happy-dom)["']|require\(["'](?:jsdom|happy-dom)["']\)/);
assert.doesNotMatch(vercelAISDKConsumerSmoke, /document\.|window\.|HTMLElement|customElements/);
assert.doesNotMatch(vercelAISDKConsumerSmoke, /@ai-presence\/face|@ai-presence\/react|react-dom|ReactDOM|renderPresenceFaceSvg|<svg|svg/i);
...
assert.match(integrationQuickstart, /node examples\/vercel-ai-sdk-presence\.mjs/);
...
assert.match(integrationQuickstart, /framework=vercel-ai-sdk/);
...
assert.match(integrationQuickstart, /Vercel AI SDK Mapping/);
assert.match(integrationQuickstart, /ai-sdk\.dev\/docs\/reference\/ai-sdk-ui\/use-chat/);
assert.match(integrationQuickstart, /ai-sdk\.dev\/docs\/ai-sdk-ui\/chatbot/);
assert.match(integrationQuickstart, /status.*submitted.*streaming.*ready.*error/s);
assert.match(integrationQuickstart, /messages.*UIMessage\[\]/);
assert.match(integrationQuickstart, /onFinish\.isAbort/);
...
assert.match(validation, /npm run demo:vercel-ai-sdk/);
...
assert.match(validation, /framework=vercel-ai-sdk/);
assert.match(validation, /abortState=interrupted/);
assert.match(validation, /errorState=error/);
...
assert.match(validation, /Vercel AI SDK `useChat` status\/message path/);
assert.match(validation, /vercel-ai-sdk consumer smoke ok/);
assert.match(validation, /status=streaming/);
assert.match(validation, /state=waiting/);
assert.match(validation, /phase=before-output/);
assert.match(validation, /surfaceFirstOutputMs=none/);
assert.match(validation, /abortState=interrupted/);
assert.match(validation, /errorState=error/);
assert.match(validation, /assistant-ui ExternalStoreRuntime route/);
assert.match(validation, /vanilla status-surface adoption path/);
assert.match(validation, /vanilla status-surface consumer smoke ok/);
assert.match(validation, /surfaceFirstOutputMs=none/);
assert.match(validation, /positive `surfaceLeadMs`/);
assert.match(validation, /not a browser or visual proof/);
assert.match(validation, /surface=assistant-ui-external-store/);
...
assert.match(goalLoop, /Published-package consumer smoke now covers generic chat, OpenAI Responses, Vercel AI SDK `useChat`, assistant lifecycle, assistant-ui ExternalStoreRuntime, vanilla status-surface, and composer-lane adoption paths/);
assert.match(goalLoop, /Vercel AI SDK `useChat` evidence/);
assert.match(goalLoop, /framework=vercel-ai-sdk/);
...
const vercelAISDKPresence = readFileSync(resolve(root, "examples/vercel-ai-sdk-presence.mjs"), "utf8");
assert.match(vercelAISDKPresence, /@ai-presence\/core/);
assert.match(vercelAISDKPresence, /@ai-presence\/adapters/);
assert.match(vercelAISDKPresence, /createPresenceRuntime/);
assert.match(vercelAISDKPresence, /createPresenceTrace/);
assert.match(vercelAISDKPresence, /presenceControlInputsForSnapshot/);
assert.match(vercelAISDKPresence, /summarizePresenceTrace/);
assert.match(vercelAISDKPresence, /createVercelAISDKAdapter/);
assert.match(vercelAISDKPresence, /ai-sdk\.dev\/docs\/reference\/ai-sdk-ui\/use-chat/);
assert.match(vercelAISDKPresence, /ai-sdk\.dev\/docs\/ai-sdk-ui\/chatbot/);
assert.match(vercelAISDKPresence, /status: "submitted"/);
assert.match(vercelAISDKPresence, /status: "streaming"/);
assert.match(vercelAISDKPresence, /status: "ready"/);
assert.match(vercelAISDKPresence, /status: "error"/);
assert.match(vercelAISDKPresence, /role: "assistant"/);
assert.match(vercelAISDKPresence, /parts: \[\{ type: "text", text: "" \}\]/);
assert.match(vercelAISDKPresence, /isAbort: true/);
assert.match(vercelAISDKPresence, /data-framework/);
assert.match(vercelAISDKPresence, /data-status/);
assert.match(vercelAISDKPresence, /data-presence-state/);
assert.match(vercelAISDKPresence, /data-presence-phase/);
assert.match(vercelAISDKPresence, /data-assistant-text-empty/);
assert.match(vercelAISDKPresence, /data-presence-before-output/);
assert.match(vercelAISDKPresence, /vercel-ai-sdk:summary/);
assert.match(vercelAISDKPresence, /framework=vercel-ai-sdk/);
assert.match(vercelAISDKPresence, /statusPath=/);
assert.match(vercelAISDKPresence, /frameworkEventPath=/);
assert.match(vercelAISDKPresence, /streamOpenMs=/);
assert.match(vercelAISDKPresence, /firstOutputMs=/);
assert.match(vercelAISDKPresence, /leadMs=/);
assert.match(vercelAISDKPresence, /presenceBeforeOutputMs=/);
assert.match(vercelAISDKPresence, /abortState=/);
assert.match(vercelAISDKPresence, /errorState=/);
assert.doesNotMatch(vercelAISDKPresence, /from ["']ai["']|require\(["']ai["']\)/);
assert.doesNotMatch(vercelAISDKPresence, /from ["']@ai-sdk\/|require\(["']@ai-sdk\//);
assert.doesNotMatch(vercelAISDKPresence, /@ai-presence\/face|packages\/face|renderPresenceFaceSvg|faceExpressionForPresence|<svg|svg/i);
assert.doesNotMatch(vercelAISDKPresence, /@ai-presence\/react|react-dom|ReactDOM|createPresenceReactBindings/);
assert.doesNotMatch(vercelAISDKPresence, /emotion[- ]detection|private emotion|private inference/i);
...
assert.match(adaptersReadme, /## Vercel AI SDK/);
assert.match(adaptersReadme, /ai-sdk\.dev\/docs\/reference\/ai-sdk-ui\/use-chat/);
assert.match(adaptersReadme, /ai-sdk\.dev\/docs\/ai-sdk-ui\/chatbot/);
assert.match(adaptersReadme, /submitted/);
assert.match(adaptersReadme, /streaming with no assistant content -> stream-open -> waiting/);
assert.match(adaptersReadme, /onFinish\.isAbort/);
assert.match(adaptersReadme, /node examples\/vercel-ai-sdk-presence\.mjs/);
assert.match(adaptersReadme, /framework=vercel-ai-sdk/);
assert.match(adaptersReadme, /statusPath/);
assert.match(adaptersReadme, /abortState=interrupted/);
...
assert.match(rootReadme, /examples\/vercel-ai-sdk-presence\.mjs/);
...
assert.match(rootReadme, /npm run demo:vercel-ai-sdk/);
...
assert.match(rootReadme, /named Vercel AI SDK adoption proof/i);
assert.match(rootReadme, /framework=vercel-ai-sdk/);
assert.match(rootReadme, /onFinish\.isAbort/);
assert.match(rootReadme, /abortState=interrupted/);
...
assert.match(rootReadme, /release consumer smoke now repeats the OpenAI Responses adapter path, Vercel AI SDK `useChat` status\/message path, assistant lifecycle adapter path, assistant-ui ExternalStoreRuntime route, vanilla status-surface pattern, and composer-lane pattern/i);
